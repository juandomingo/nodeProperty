...
var getJsonArr = function(json,callback){
    ...
    var rightmove = {
        "getResults" : function(postcode,radius,days,callback,done){_done = done;_callback = callback; _postcode=postcode; _radius= radius;_loop = 0; _days = days;_cant= 999;_maxLoop = 999;_cant=0; getPostCode()}
    }
